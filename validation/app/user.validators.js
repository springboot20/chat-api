...
export const userRegisterValidation = () => {
  return [
    ...
    body('role').optional().trim().isIn(AvailableUserRole).withMessage('Invalid user role'),
  ];
};
...
export const userAssignRoleValidation = () => {
  return [body('role').trim().optional().isIn(AvailableUserRole).withMessage('Invalid user role')];
};
